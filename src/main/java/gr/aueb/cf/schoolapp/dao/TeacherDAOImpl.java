...
public class TeacherDAOImpl implements ITeacherDAO {
    ...
    public Teacher insert(Teacher teacher) throws TeacherDAOException {
        ...
        PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("Insert SQL error. Teacher: " + teacher + " was not inserted.");
        }
    }
    ...
    public Teacher update(Teacher teacher) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("Update SQL error. Teacher: " + teacher + " was not updated.");
        }
    }
    ...
    public void delete(Integer id) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("Delete SQL error. Teacher with id: " + id + " was not deleted.");
        }
    }
